/**
 * shadcn/ui Button (new-york). Liegt hier, damit die shadcn-Verdrahtung
 * (components.json, cn(), Tailwind-Tokens) nachweislich funktioniert.
 * Weitere Komponenten per `npx shadcn@latest add <name>` ergaenzen.
 */
